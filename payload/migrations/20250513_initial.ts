...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  await db.execute(sql`CREATE UNIQUE INDEX IF NOT EXISTS "portfolio_slug_idx" ON "portfolio" USING btree ("slug");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "portfolio_status_idx" ON "portfolio" USING btree ("status");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "portfolio_created_at_idx" ON "portfolio" USING btree ("created_at");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "portfolio_updated_at_idx" ON "portfolio" USING btree ("updated_at");`)
  await db.execute(sql`CREATE UNIQUE INDEX IF NOT EXISTS "services_slug_idx" ON "services" USING btree ("slug");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "services_created_at_idx" ON "services" USING btree ("created_at");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "services_updated_at_idx" ON "services" USING btree ("updated_at");`)
  ...
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "clients_created_at_idx" ON "clients" USING btree ("created_at");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "clients_updated_at_idx" ON "clients" USING btree ("updated_at");`)
  await db.execute(sql`CREATE UNIQUE INDEX IF NOT EXISTS "blog_posts_slug_idx" ON "blog_posts" USING btree ("slug");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "blog_posts_status_idx" ON "blog_posts" USING btree ("status");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "blog_posts_created_at_idx" ON "blog_posts" USING btree ("created_at");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "blog_posts_updated_at_idx" ON "blog_posts" USING btree ("updated_at");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "nav_main_nav_order_idx" ON "navigation_main_nav" USING btree ("_order");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "nav_main_nav_parent_id_idx" ON "navigation_main_nav" USING btree ("_parent_id");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_prefs_key_idx" ON "payload_preferences" USING btree ("key");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_prefs_created_at_idx" ON "payload_preferences" USING btree ("created_at");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_prefs_updated_at_idx" ON "payload_preferences" USING btree ("updated_at");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_prefs_rels_order_idx" ON "payload_preferences_rels" USING btree ("order");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_prefs_rels_parent_idx" ON "payload_preferences_rels" USING btree ("parent_id");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_prefs_rels_path_idx" ON "payload_preferences_rels" USING btree ("path");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_prefs_rels_users_id_idx" ON "payload_preferences_rels" USING btree ("users_id");`)
  ...
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_locked_docs_global_slug_idx" ON "payload_locked_documents" USING btree ("global_slug");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_locked_docs_created_at_idx" ON "payload_locked_documents" USING btree ("created_at");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_locked_docs_rels_order_idx" ON "payload_locked_documents_rels" USING btree ("order");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_locked_docs_rels_parent_idx" ON "payload_locked_documents_rels" USING btree ("parent_id");`)
  await db.execute(sql`CREATE INDEX IF NOT EXISTS "payload_locked_docs_rels_path_idx" ON "payload_locked_documents_rels" USING btree ("path");`)
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  await db.execute(sql`DROP TABLE IF EXISTS "navigation_main_nav";`)
  await db.execute(sql`DROP TABLE IF EXISTS "navigation";`)
  ...
  await db.execute(sql`DROP TABLE IF EXISTS "team_members";`)
  await db.execute(sql`DROP TABLE IF EXISTS "services";`)
  await db.execute(sql`DROP TABLE IF EXISTS "portfolio";`)
  await db.execute(sql`DROP TABLE IF EXISTS "media";`)
  await db.execute(sql`DROP TABLE IF EXISTS "users_sessions";`)
  await db.execute(sql`DROP TABLE IF EXISTS "users";`)
  await db.execute(sql`DROP TYPE IF EXISTS "public"."enum_blog_posts_status";`)
  await db.execute(sql`DROP TYPE IF EXISTS "public"."enum_portfolio_status";`)
  await db.execute(sql`DROP TYPE IF EXISTS "public"."enum_portfolio_category";`)

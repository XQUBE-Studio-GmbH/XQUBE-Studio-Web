...
export async function POST(req: NextRequest) {
  try {
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#0e0e0e;color:#c4cad8;padding:32px;border-radius:8px;">
          <div style="border-left:3px solid #14CB72;padding-left:16px;margin-bottom:24px;">
            <h2 style="color:#ffffff;margin:0 0 4px;">New Contact Inquiry</h2>
            <p style="color:#8d95a8;margin:0;font-size:14px;">Via xqubestudio.com</p>
          </div>
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#0e0e0e;color:#c4cad8;padding:32px;border-radius:8px;">
          <h2 style="color:#ffffff;margin:0 0 16px;">We received your message.</h2>

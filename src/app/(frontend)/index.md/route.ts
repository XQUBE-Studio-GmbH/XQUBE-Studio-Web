 ...
 * GET /index.md
 *
 * Exposes a markdown summary of the homepage for AI crawlers and agents.
 * Satisfies the [C1] AIScan "expose /path/index.md" requirement.
 * Content-Type is set explicitly to text/markdown — not inferred from the path.
 */

const MARKDOWN = `# XQUBE Studio — Where Art Meets Precision
